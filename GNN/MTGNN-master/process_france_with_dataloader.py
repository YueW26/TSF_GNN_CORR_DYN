...
if __name__ == "__main__":
    ...
    if args.step in ['all', 'prepare']:
        ...
        num_features = 10  # Default value for France (10 features)python train.py --data data/FRANCE --gcn_bool --adjtype doubletransition --addaptadj --randomadj --epochs 1 --seq_length 6 --pred_length 6
